...
(defconst rst-cvs-header
  "$CVSHeader: sm/rst_el/rst.el,v 1.327.2.24 2015/10/04 09:08:14 stefan Exp $")
...
(defconst rst-svn-timestamp
  (rst-extract-version "\\$" "LastChangedDate: " ".+?+" " "
		       "$LastChangedDate: 2015-10-04 09:21:35 +0000 (Sun, 04 Oct 2015) $")
...
(defcustom rst-compile-toolsets
  `((html ,(if (executable-find "rst2html.py") "rst2html.py" "rst2html")
    ...
    (s5 ,(if (executable-find "rst2s5.py") "rst2s5.py" "rst2s5")
        ".html" "--theme-url=ui/freedom --current-slide"))
...
(defvar rst-compile-primary-toolset 's5
